...
public class SortAdapter extends RecyclerView.Adapter<SortAdapter.ViewHolder> {
     ...
     * Update the list
     *
     * @param list that needs to be updated
     */
    ...
    /**
     * get the value of char ascii based on the position of ListView
    ...
    /**
     * get the first character position based on the value of char ascii
     * @param section the position of first character
     */
